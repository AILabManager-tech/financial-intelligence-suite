...
- **`main` = P4.3 MWR/IRR actif (ce bloc, NON poussé) ; origin à jour jusqu'à P4.5.** `origin/main` = `ea124ca` (7 commits poussés le 2026-06-01 : P5.10→P4.5). ⚠️ **P4.3 MWR/IRR = 1 commit devant origin, NON poussé.** Push après simple avertissement, jamais `--force`. Branche `main`.
- **788 tests verts** (P4.5 : →780 ; P4.3 : 780→788, +8 : 5 util moneyWeightedReturn + 3 panel), lint + build verts. Node v24 via nvm : `export PATH="$HOME/.nvm/versions/node/v24.14.1/bin:$PATH"`.
