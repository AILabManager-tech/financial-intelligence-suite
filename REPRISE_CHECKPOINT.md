...
- **803 tests verts** (P4.6 : →795 ; P4.7 : 795→803, +8 : 5 util benchmarkStats + 3 panel). Blocs livrés cette session autonome : P4.3 MWR `d97d642`, P4.6 benchmark `8be14bc`, P4.7 beta/corr (en cours de commit), puis P4.8, P4.11, puis Phase 5. lint + build verts. Node v24 via nvm : `export PATH="$HOME/.nvm/versions/node/v24.14.1/bin:$PATH"`.
